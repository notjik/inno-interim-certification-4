...
if __name__ == '__main__':
    ...
    formatter_messages = logging.Formatter("[%(asctime)s]: <%(levelname)s> "
                                           ...
                                           datefmt="%Y-%m-%d %H:%M:%S")
    _handler_logfile = logging.FileHandler(LOG_MESSAGE_PATH, mode='a')
    ...
    formatter_messages = logging.Formatter("[%(asctime)s]: <%(levelname)s> "
                                           ...
                                           datefmt="%Y-%m-%d %H:%M:%S")
    _handler_logfile = logging.FileHandler(LOG_DB_PATH, mode='a')
    _handler_logfile.setFormatter(formatter_messages)
    ...
    formatter_messages = logging.Formatter("[%(asctime)s]: <%(levelname)s> "
                                           ...
                                           datefmt="%Y-%m-%d %H:%M:%S")
    _handler_logfile = logging.FileHandler(LOG_STATUS_PATH, mode='a')
    _handler_logfile.setFormatter(formatter_messages)
    _handler_console = logging.StreamHandler(sys.stdout)
    _handler_console.setFormatter(formatter_messages)
